...
- **Tools:** Azure MCP (get_pipeline_runs, get_pipeline_logs, get_build_timeline, get_test_results, get_work_items), create_work_item (HITL approval), ReasoningTools
...
- **Azure MCP:** Uses standardized Azure DevOps tools via MCP protocol with HTTP/SSE transport
